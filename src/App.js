...
<div>
    <header className="header">
        ...
        <nav className="nav2">
            <a href="#"><img src='group 82.png'></img></a>
            <a href="#"><img src="Group 83.png"></img></a> 
            <a href="#"><img src="Group 84.png"></img></a> 
        </nav>
    </header>

    <div className="profile-container">
        <div className="profile-card">
            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/cc9acba689f81ba9d2ecbc8f521b9ce65f76070b0a958433d0bbed78957a5941?placeholderIfAbsent=true&apiKey=26bd9a38384c4232b7f8df003fc57b5b" alt="Profile Picture"/>
            <div className="info">
                <p>Россия, Сочи</p>
                <p> <span><img className='BEBE' src="image.png" alt=""/></span>32 </p>
        ...
        <div className="profile-name">ИМЯ<br/>ФАМИЛИЯ</div>
    </div>
